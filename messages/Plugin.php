            ...
            ->children()
                ->arrayNode('messages')
                    ...
                    ->children()
                        ...
                        ->arrayNode('translation_dirs')
                            ->prototype('scalar')->end()
                            ->defaultValue(['vendor/zicht', 'src'])
                            ->info('The default dirs are compatible with Symfony 2.8 and lower, Symfony 3 and higher don\'t use /src but /translations by convention')
                        ->end()
